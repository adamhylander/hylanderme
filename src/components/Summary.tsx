...
function Summary() {
  return (
    <Box>
      ...
      <div
        style={{ fontFamily: "Roboto Mono", fontSize: "1.4rem" }}
      >
        ...
        particular interest in penetration testing and red teaming, and I am
        currently in the process of doing my master thesis at FOI (Swedish
